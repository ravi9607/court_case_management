...
$sql="SELECT lawyer_first_name, lawyer_last_name, lawyer_email, lawyer_phone_no, lawyer_city, lawyer_address, lawyer_rating, specialization, lawyer_image from lawyer_login WHERE lawyer_id = ?";
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                echo '<form action="" method="post" enctype="multipart/form-data">
                    <input type="file" name="up-image">
                    <input type="submit" name="img-submit">
                    </form>';
...
?>
                    ...
                    <p class="profile__line">
                        Name: <div><b><?php echo "{$fname} {$lname}" ?></b>
                        </div>
                    </p>
                    <p class="profile__line">
                        Email: <div><b><?php echo $email ?></b>
                        </div>
                    </p>
                    <p class="profile__line">
                        Phone No: <div><b><?php echo $phone ?></b>
                        </div>
                    </p>
                    <p class="profile__line">
                        City: <div><b><?php echo $city ?></b>
                        </div>
                    </p>
                    <p class="profile__line">
                        Address: <div><b><?php echo $address ?></b>
                        </div>
                    </p>
                    <p class="profile__line">
